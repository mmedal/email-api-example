...
test('auth mw should return 401 when basic auth not included in request', t => {
  request(app).get('/api')
    .expect(401)
    .end((err, res) => {
...
test('auth mw should return 401 when basic auth is wrong', t => {
...
test('auth mw should return 200 when basic auth successful', t => {
